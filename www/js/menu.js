    ...
    success: function(data) {
      ...
      if (indexFile) {
        if (indexFile.id == curentSite) {
          downloadButtons += '<li><a class="menu-button active" href="' + indexFile.url + '">' + indexFile.title + '</a></li>';
      } else {
        downloadButtons += '<li><a class="menu-button" href="' + indexFile.url + '">' + indexFile.title + '</a></li>';
      }
      }
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        if (file.id !== "index") {
          if (file.id === curentSite) {
            downloadButtons += '<li><a class="menu-button active" href="' + filePath + '">' + fileName + '</a></li>';
          } else {
            downloadButtons += '<li><a class="menu-button" href="' + filePath + '">' + fileName + '</a></li>';
          }
        }
      }
